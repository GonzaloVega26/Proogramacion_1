...
#ifndef PROGRAM1_H                                      // Si se carga por vez 1ª
#define PROGRAM1_H
...
#endif
#ifndef TECLAS
#include <termios.h>                                        // (sólo para Linux)
#include <unistd.h>
...
#define limpiar                cout << "\033[2J\033[1;1H";/*cout << string(22, '\n')*/;
#endif
// Sólo para Windows
#else
#include <conio.h>
...
#define esUconDieresis(x)      (strchr("üÜ",x))
#define esVocal(x)             (strchr("AEIOUaeiouáéíóúüÁÉÍÓÚÜ",x))
#define esVocalAcentuada(x)    (strchr("áéíóúÁÉÍÓÚ",x))
#define esVocalAbierta(x)      (strchr("AEOaeoáéóÁÉÓ",x))
#define esVocalCerrada(x)      (strchr("IUiuíúüÍÚÜ",x))
